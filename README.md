...
## Transaction
Класс транзакции, представляющий определенную операцию по данному счету. Он содержит тип, сумму, дату и описание операции, а также категорию к которой эта операция относится.